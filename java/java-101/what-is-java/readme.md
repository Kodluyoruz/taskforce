...
**1-** Java programlama dili neden platform bağımsızdır?

**2-** Java programlama dili günümüzde hangi firma tarafından geliştirilmektedir?

**3-** Java programlama dili ile geliştirilebilecek uygulamalar nelerdir?

**4-** Java'nın multithread özelliği barındırmasının avantajı nedir?

**5-** Java'da kullanılmayan veya işi biten nesnelerin hafızadan temizlenmesi işi hangi mekanizma ile sağlanmaktadır?

### Cevaplar

**1-** Kaynak program derlenerek byte kodu yaratılır. Byte kodu Java derleyicisi olan her bilgisayarda çalışır. CPU ve işletim sistemine bağlı değildir.

**2-** Oracle

**3-** Mobil, masaüstü, grafiksel ve web tabanlı uygulamalar geliştirilebilir.

**4-** Eş zamanlı işlemleri programlayabilmemize imkan tanır.
