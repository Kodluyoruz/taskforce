...
![backend-vs-frontend1](figures/backend-vs-frontend1.png)

![frontend-vs-backend2](figures/frontend-vs-backend2.jpg)

Ek olarak frontend ve backend kavramlarını daha iyi anlamak için bu kavramları insan biyolojisine uyarlayalım.

![frontend-vs-backend3](figures/frontend-vs-backend3.png)
...
![frontend-vs-backend4](figures/frontend-vs-backend4.jpg)
...
![fullstack](figures/fullstack.png)
