...
#### Patikaya Giriş ####
- [Eğitime Genel Bakış ve Öneriler](egitime-genel-bakis-oneriler/)
- [Temel Kavramlar](temel-kavramlar/)
- [Java Nedir](java-nedir/)
- [Java Geliştirme Araçlarının Kurulumu](ide-kurulumu/)
...
- [Pratik - Not Ortalaması Hesaplayan Program](pratik-not-ortalamasi/)
- [Pratik - KDV Tutarı Hesaplayan Program](pratik-kdv-hesaplama/)
- [Pratik - Dik Üçgende Hipotenüs Bulan Program](pratik-hipotenus-bulma/)
- [Pratik - Taksimetre Hesaplayan Program](pratik-taksimetre/)
- [Pratik - Dairenin Alanını ve Çevresini Bulan Program](pratik-daire-alan-cevre/)
- [Ödev - Vücut Kitle İndeksi Hesaplayan Program](odev-vucut-kitle-hesaplama/)
- [Ödev - Manav Kasa Programı](odev-manav-kasa/)
...
- [Pratik - Kullanıcı Girişi](pratik-login-1/)
- [Pratik - Sınıfı Geçme Durumu](pratik-sinif-gecme/)
- [Pratik - Hava Sıcaklığına Göre Etkinlik Önerme](pratik-etkinlik-onerme/)
- [Pratik - Sayıları Büyükten Küçüğe Sıralama](pratik-sayi-siralama/)
...
- [Pratik - Üslü Sayı Hesaplayan Program](pratik-uslu-sayi/)
- [Pratik - Armstrong Sayıları Bulan Program](pratik-armstrong-1/)
- [Pratik - Harmonik Sayıları Bulan Program](pratik-harmonic/)
- [Pratik - Yıldızlar ile Üçgen Yapımı](pratik-yildiz-ucgen/)
- [Pratik - ATM Projesi](pratik-atm/)
- [Pratik - EBOB-EKOK Bulan Program](pratik-ebob-ekok/)
...
- [Ödev - Dizideki Elemanları Sıralama](odev-array-order/)
- [Ödev - Dizideki Elemanların Frekansı](odev-array-count/)
- [Ödev - Matris Transpozunu Bulma](odev-array-transpose/)
